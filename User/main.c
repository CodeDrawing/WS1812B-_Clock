...
//test
const uint8_t digit[10][64] = {
  // Digit "0"
  {
   0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Empty space around the digit
   0x00, 0x99, 0x21, 0x21, 0x21, 0x21, 0x21, 0x00, // Empty space around the digit
   0x00, 0x99, 0x00, 0x00, 0x00, 0x00, 0x21, 0x00, // Empty space around the digit
   0x00, 0x99, 0x00, 0x00, 0x00, 0x00, 0x21, 0x00, // Empty space around the digit
   0x00, 0x99, 0x00, 0x00, 0x00, 0x00, 0x21, 0x00, // Empty space around the digit
   0x00, 0x99, 0x00, 0x00, 0x00, 0x00, 0x21, 0x00, // Empty space around the digit
   0x00, 0x99, 0x21, 0x21, 0x21, 0x21, 0x21, 0x00, // Empty space around the digit
  ...
  // The same way, define other digits...
  // Remember to horizontally flip every other row.
};
...
void ColorLight_Mode3(void)
{
	...
	for(i=0;i<65;i++)
	{
		...
		WS2812B_Buf[i]=digit[0][i];
			
	}
	for(i=0;i<65;i++)
	{
		//WS2812B_Buf[i]=rand()%0x1000000;
		WS2812B_Buf[i+64]=digit[0][i];
